...
def scale(arr: typing.Annotated[numpy.typing.ArrayLike, numpy.float32], scalar: typing.SupportsFloat | typing.SupportsIndex) -> numpy.typing.NDArray[numpy.float32]:
    """
